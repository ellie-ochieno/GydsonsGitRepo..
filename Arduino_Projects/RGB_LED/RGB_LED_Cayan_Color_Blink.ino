     ...
     /**
        PROGRAM TO BLINK THE RGB LED IN CYAN/AQUA COLOR MAKING USE OF THE 
...
int rColorStrength = 0;          //red LED brightness intesity set to 0 
int gColorStrength = 255;        //green LED brightness intesity set to 255
