     ...
     /**
        PROGRAM TO BLINK THE RGB LED IN ORANGE COLOR MAKING USE OF THE 
...
int gColorStrength = 165;        //green LED brightness intesity set to 0
int bColorStrength = 0;          //blue LED brightness intesity set to 255
