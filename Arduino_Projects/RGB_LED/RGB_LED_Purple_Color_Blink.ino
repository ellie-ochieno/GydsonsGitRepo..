     ...
     /**
        PROGRAM TO BLINK THE RGB LED IN PURPLE COLOR MAKING USE OF THE 
...
int rColorStrength = 128;        //red LED brightness intesity set to 255 
int gColorStrength = 0;          //green LED brightness intesity set to 0
int bColorStrength = 128;        //blue LED brightness intesity set to 255
